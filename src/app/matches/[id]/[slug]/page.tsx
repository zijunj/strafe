...
export default async function MatchDetailPage(props: {
  ...
  console.log(match.head_to_head);
    ...
    <div className="max-w-4xl mx-auto p-6 text-white space-y-6">
      ...
      <div className="flex justify-between items-center bg-[#1a1a1a] p-6 rounded-lg">
        <div className="flex items-center space-x-3">
          <img src={match.team1_logo} alt={match.team1} className="w-12 h-12" />
          <div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <img src={match.team2_logo} alt={match.team2} className="w-12 h-12" />
        </div>
      </div>
          ...
          <div>
            ...
            <div className="divide-y divide-gray-700">
              {match.head_to_head.map((h2h, idx) => (
                ...
                >
                  {/* Left: Date */}
                  <div className="w-1/4 text-xs text-gray-400">{h2h.date}</div>
                  ...
                  <div className="w-1/4 text-right">
                    ...
                    <p className="text-xs text-gray-400">{h2h.event_series}</p>
                  </div>
                </a>
              ))}
            </div>
      ...
      <div className="bg-[#202020] p-4 rounded-lg">
        ...
        <p className="text-gray-300 text-sm leading-relaxed">
          ...
          <span className="font-bold">{match.match_event}</span>. Stay tuned for
